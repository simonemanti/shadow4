"""
The s4 ellipsoid mosaic crystal (optical element and beamline element).
"""
...
class S4EllipsoidMosaicCrystal(S4MosaicCrystal, S4EllipsoidOpticalElementDecorator):
    """
    Shadow4 Ellipsoid Mosaic Crystal Class
    This is an ellipsoidal curved mosaic crystal in reflection geometry (Bragg), using the diffracted beam.
    ...
    Returns
    -------
    instance of S4EllipsoidMosaicCrystal.
    """
    def __init__(self,
                 name="Ellipsoid mosaic crystal",
                 boundary_shape=None,
                 material="graphite",
                 miller_index_h=1,
                 miller_index_k=1,
...
from shadow4.beamline.optical_elements.mosaic_crystals.s4_ellipsoid_mosaic_crystal import S4EllipsoidMosaicCrystal
optical_element = S4EllipsoidMosaicCrystal(name={name!r},
...
class S4EllipsoidMosaicCrystalElement(S4MosaicCrystalElement):
    """
    The Shadow4 ellipsoid crystal element.
    It is made of a S4EllipsoidMosaicCrystal and an ElementCoordinates instance. It also includes the input beam.
    ...
    """
    def __init__(self,
                 optical_element : S4EllipsoidMosaicCrystal = None,
                 coordinates : ElementCoordinates = None,
                 movements: S4BeamlineElementMovements = None,
                 input_beam : S4Beam = None):
        super().__init__(optical_element=optical_element if optical_element is not None else S4EllipsoidMosaicCrystal(),
    ...
    def to_python_code(self, **kwargs):
        ...
        **kwargs
        ...
        txt += "\nfrom shadow4.beamline.optical_elements.mosaic_crystals.s4_ellipsoid_mosaic_crystal import S4EllipsoidMosaicCrystalElement"
        txt += "\nbeamline_element = S4EllipsoidMosaicCrystalElement(optical_element=optical_element, coordinates=coordinates, movements=movements, input_beam=beam)"
