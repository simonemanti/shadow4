"""
The s4 toroid mosaic crystal (optical element and beamline element).
"""
...
class S4ToroidMosaicCrystal(S4MosaicCrystal, S4ToroidOpticalElementDecorator):
    """
    Shadow4 Toroid Mosaic Crystal Class
    This is a toroid curved mosaic crystal in reflection geometry (Bragg), using the diffracted beam.
    ...
    Returns
    -------
    instance of S4ToroidMosaicCrystal.
    """
    def __init__(self,
                 name="Toroid mosaic crystal",
                 boundary_shape=None,
                 material="graphite",
                 miller_index_h=1,
                 miller_index_k=1,
...
from shadow4.beamline.optical_elements.mosaic_crystals.s4_toroid_mosaic_crystal import S4ToroidMosaicCrystal
optical_element = S4ToroidMosaicCrystal(name={name!r},
    ...
    min_radius={min_radius}, # min_radius = sagittal
    maj_radius={maj_radius}, # maj_radius = tangential
    f_torus={f_torus},
...
class S4ToroidMosaicCrystalElement(S4MosaicCrystalElement):
    """
    The Shadow4 toroid crystal element.
    It is made of a S4ToroidMosaicCrystal and an ElementCoordinates instance. It also includes the input beam.
    ...
    """
    def __init__(self,
                 optical_element : S4ToroidMosaicCrystal = None,
                 coordinates : ElementCoordinates = None,
                 movements: S4BeamlineElementMovements = None,
                 input_beam : S4Beam = None):
        super().__init__(optical_element=optical_element if optical_element is not None else S4ToroidMosaicCrystal(),
    ...
    def to_python_code(self, **kwargs):
        ...
        **kwargs
        ...
        txt += "\nfrom shadow4.beamline.optical_elements.mosaic_crystals.s4_toroid_mosaic_crystal import S4ToroidMosaicCrystalElement"
        txt += "\nbeamline_element = S4ToroidMosaicCrystalElement(optical_element=optical_element, coordinates=coordinates, movements=movements, input_beam=beam)"
